...
public class HubDisplay extends AbstractOutputDevice {
    ...
    public void noDStations(List<String> stationData) {
        logger.fine(getInstanceName());
        
        String deviceClass = "HubDisplay";
        String deviceInstance = getInstanceName();
        String messageName = "numberOfDS";
        
        List<String> messageArgs = new ArrayList<String>();
        messageArgs.addAll(stationData);
    ...
    public void showStatus(List<String> data) {
        logger.fine(getInstanceName());
        
        String deviceClass = "HubDisplay";
        String deviceInstance = getInstanceName();
        String messageName = "status";
        
        List<String> messageArgs = new ArrayList<String>();
        String[] preludeArgs = 
            {"JourneyNumber", "AvailableDP", "noOfUsers", "averageJourneyTime"};
        messageArgs.addAll(Arrays.asList(preludeArgs));
