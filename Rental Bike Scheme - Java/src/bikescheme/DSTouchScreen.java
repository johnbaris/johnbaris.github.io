...
public class DSTouchScreen extends AbstractIODevice {
    ...
    public void showUserActivity(List<String> activityData) {
        ...
        String[] preludeArgs =  {"HireTime","HireDS","ReturnDS","Duration (min)"};
        ...
        public void findDPoints(String instanceName, int eastPos, int northPos, int numPoints) {
        	
            logger.fine(getInstanceName());
            
            String deviceClass = "DSTouchScreen";
            String deviceInstance = getInstanceName();
            String messageName = "showLocations";
            
            List<String> messageArgs = new ArrayList<String>();
            String[] preludeArgs = {instanceName, String.valueOf(eastPos),String.valueOf(northPos),String.valueOf(numPoints)};
            messageArgs.addAll(Arrays.asList(preludeArgs));
